...
let getItemFromDynamicForward = (card) => {
	...
	return { title, link, description, pubDate, guid, author, category };
};
...
export { getPubDate, getItemFromDynamicForward, getItemFromDynamicAv, getItemFromDynamicDraw, getItemFromDynamicDefault, getItemFromPaidDynamic, getItemFromDynamic };
