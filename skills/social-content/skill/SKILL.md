...
metadata:
  version: 2.0.0
  upstream-name: social
  upstream-repository: coreyhaines31/marketingskills
  upstream-path: skills/social/SKILL.md
---
...
- "[Impressive result] 鈥?and it only took [surprisingly short time]."
...
Turn one piece of content into many. The best social content isn't created from scratch 鈥?it's extracted from longer-form pillar content and adapted to each platform.

### Blog Post 鈫?Social Content
...
### Podcast / Video 鈫?Social Content

Extract "content atoms" 鈥?self-contained moments from any long-form content that work on their own:
...
1. **Get transcript** 鈥?use Whisper, Descript, or your podcast host's transcription
2. **Mark timestamps** 鈥?flag the 5-10 best moments while listening or scanning transcript
3. **Extract clips** 鈥?pull video/audio clips for each moment (Descript, Opus Clip, or manual)
4. **Write standalone captions** 鈥?each clip needs context; don't assume the viewer heard the rest
5. **Add subtitles** 鈥?most social video is watched without sound
6. **Schedule across 1-2 weeks** 鈥?spread a single episode across multiple posts
...
### Webinar / Live Event 鈫?Social Content
...
| Full recording 鈫?short clips | Reels, TikTok, Shorts |

### Newsletter 鈫?Social Content
...
2. **Extract content atoms** (5-10 per piece 鈥?quotes, stories, tips, data)
...
1. **Find creators** 鈥?10-20 accounts with high engagement
2. **Collect data** 鈥?500+ posts for analysis
3. **Analyze patterns** 鈥?Hooks, formats, CTAs that work
4. **Codify playbook** 鈥?Document repeatable patterns
5. **Layer your voice** 鈥?Apply patterns with authenticity
6. **Convert** 鈥?Bridge attention to business results
...
1. **Slow hooks** 鈥?don't build up to the point
2. **No text overlay** 鈥?many watch without sound
3. **Poor audio** 鈥?bad audio kills retention instantly
4. **Too long** 鈥?if it can be shorter, make it shorter
5. **No CTA** 鈥?tell viewers what to do
6. **Ignoring comments** 鈥?engagement in first hour matters
